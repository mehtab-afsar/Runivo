...
function IconFeed({ color, sw }: { color: string; sw: number }) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={color}>
      <rect x="3" y="3" width="18" height="5" rx="1" strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round"/>
      <rect x="3" y="11" width="18" height="5" rx="1" strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round"/>
      <line x1="3" y1="19" x2="8" y2="19" strokeWidth={sw} strokeLinecap="round"/>
    </svg>
  )
}
...
function IconCoach({ color, sw }: { color: string; sw: number }) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={color}>
      <path d="M12 3L13.5 8H19L14.5 11.5L16 16.5L12 13L8 16.5L9.5 11.5L5 8H10.5L12 3Z"
        strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
}
      ...
      {TABS.map(tab => {
        ...
        return (
          ...
          >
            ...
            {tab.id === 'coach'   && <IconCoach   color={color} sw={sw} />}
