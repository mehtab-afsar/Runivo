import { NutritionProfile, NutritionEntry, localDateString } from '@shared/services/store';
    ...
    return products
      ...
      .map((p, i): FoodItem => {
        ...
        return {
          id:               `off-${query}-${i}`,
          name:             p.product_name!,
          kcalPer100g:      clamp(n['energy-kcal_100g'],  0, 900),
          proteinPer100g:   clamp(n['proteins_100g'],      0, 100),
          carbsPer100g:     clamp(n['carbohydrates_100g'], 0, 100),
          fatPer100g:       clamp(n['fat_100g'],           0, 100),
