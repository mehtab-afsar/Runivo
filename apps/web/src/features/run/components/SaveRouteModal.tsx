            ...
            <div className="bg-white rounded-t-3xl px-5 pt-4 pb-6">
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white text-sm
                           text-gray-900 placeholder-gray-400 outline-none focus:border-[#D93518]
                           focus:ring-2 focus:ring-[#FEF0EE] transition mb-4"
                autoFocus
              />
                  ...
                  {EMOJI_OPTIONS.map(e => (
                    <button
                      ...
                      className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg transition-all ${
                        emoji === e
                          ? 'bg-[#FEF0EE] border-2 border-[#D93518] scale-110'
              ...
              >
                {isPublic ? (
                  <Globe className="w-4 h-4 text-[#D93518]" strokeWidth={2} />
                ) : (
                ...
                <div className={`w-10 h-6 rounded-full p-0.5 transition-colors ${isPublic ? 'bg-[#D93518]' : 'bg-gray-300'}`}>
                  <motion.div
              ...
              <motion.button
                ...
                className={`w-full py-3.5 rounded-2xl text-sm font-bold transition-all ${
                  name.trim()
                    ? 'bg-gradient-to-r from-[#D93518] to-[#B82D14] text-white shadow-[0_4px_16px_rgba(217,53,24,0.25)]'
