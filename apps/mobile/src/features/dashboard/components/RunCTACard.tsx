  ...
  return (
    <Pressable style={ss.card} onPress={onPress}>
      ...
      <View style={ss.iconWrap}>
        <Play size={22} color="#fff" strokeWidth={1.5} fill="#fff" />
      </View>
    </Pressable>
  );
}
...
function mkStyles(C: AppColors) {
  return StyleSheet.create({
    ...
    left:     { flex: 1 },
    label:    { fontFamily: 'Barlow_500Medium', fontSize: 9, letterSpacing: 1.5, color: 'rgba(255,255,255,0.4)', marginBottom: 6 },
    title:    { fontFamily: 'PlayfairDisplay_400Regular_Italic', fontSize: 24, color: '#fff', fontStyle: 'italic' },
    sub:      { fontFamily: 'Barlow_300Light', fontSize: 12, color: 'rgba(255,255,255,0.5)', marginTop: 4 },
