        ...
        {activeTab === 'insights' && (
          <View style={{ gap: 10 }}>
            ...
            <View style={s.macroCard}>
              ...
              {[
                { label: 'Protein', consumed: proteinConsumed, goal: profile.proteinGoalG, pct: proteinPct, color: C.blue, unit: 'g' },
...
function mkStyles(C: AppColors) { return StyleSheet.create({
  ...
  header:       { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20, paddingTop: Platform.OS === 'android' ? 12 : 0, paddingBottom: 12, backgroundColor: C.card, borderBottomWidth: 0.5, borderBottomColor: C.border },
  back:         { width: 32 },
  ...
  dateStripScroll: { flexGrow: 0, backgroundColor: C.card, borderBottomWidth: 0.5, borderBottomColor: C.border },
  ...
  contextBanner:{ marginHorizontal: Spacing.gutter, marginTop: 4, padding: 12, backgroundColor: C.greenBg, borderRadius: 10, borderWidth: 0.5, borderColor: C.green },
  ...
  macroCard:    { backgroundColor: C.card, borderRadius: 14, borderWidth: 0.5, borderColor: C.border, padding: 14, gap: 12 },
  ...
  statsCard:    { backgroundColor: C.card, borderRadius: 14, borderWidth: 0.5, borderColor: C.border, padding: 14 },
  ...
  aiCard:       { backgroundColor: 'rgba(139,92,246,0.10)', borderRadius: 14, borderWidth: 0.5, borderColor: 'rgba(90,58,138,0.15)', padding: 14, gap: 10 },
