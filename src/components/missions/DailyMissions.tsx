    ...
    <div>
            ...
            <motion.div
              ...
              className={`bg-white rounded-2xl p-4 border transition-all shadow-sm ${
                mission.claimed
                  ...
                  : mission.completed
                  ? 'border-teal-200 shadow-[0_2px_12px_rgba(0,180,198,0.08)]'
                  : 'border-gray-100'
              }`}
            >
              <div className="flex items-start gap-3">
                <div className={`w-11 h-11 rounded-xl flex items-center justify-center text-xl shrink-0 ${
                  mission.completed ? 'bg-teal-50' : 'bg-gray-50'
                }`}>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex-1 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                      <motion.div
                        className={`h-full rounded-full ${mission.completed ? 'bg-teal-500' : 'bg-gray-300'}`}
                        initial={{ width: 0 }}
                ...
                <div className="shrink-0 ml-1">
                  {mission.completed && !mission.claimed ? (
                    <motion.button
                      ...
                      className="px-3 py-2 rounded-xl bg-gradient-to-r from-teal-500 to-teal-600
      ...
      {missions.length > 0 && missions.every(m => m.completed) && (
        <motion.div
          ...
          className="mt-4 p-4 rounded-2xl bg-gradient-to-r from-teal-50 to-purple-50
                     border border-teal-200 text-center"
        >
