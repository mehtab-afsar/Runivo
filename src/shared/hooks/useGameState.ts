...
import { PlayerStats, Territory, GameAction, Challenge, Achievement } from '@shared/types/game';
...
export const useGameState = () => {
  ...
  const [activeChallenges, _setActiveChallenges] = useState<Challenge[]>([]);
  ...
  // Daily income collection — intentionally runs once on mount only
  useEffect(() => {
    const now = new Date();
