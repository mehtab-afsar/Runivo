...
const T = {
  ...
  t2: '#6B6B6B', t3: '#ADADAD',
  red: '#D93518', redLo: '#FEF0EE', redBo: 'rgba(217,53,24,0.2)',
  green: '#1A6B40', greenLo: '#EDF7F2', amber: '#9E6800',
};
              ...
              <div style={{
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    border: `0.5px solid ${savedEvents.has(selectedEvent.id) ? T.redBo : T.border}`,
                    display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer',
                  }}
                >
